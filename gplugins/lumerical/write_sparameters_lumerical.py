...
def write_sparameters_lumerical(
    ...
    **settings,
    ...
    x_min = (component_extended.ddxmin - xmargin) * 1e-6
    x_max = (component_extended.ddxmax + xmargin) * 1e-6
    y_min = (component_extended.ddymin - ymargin) * 1e-6
    y_max = (component_extended.ddymax + ymargin) * 1e-6
    ...
    for i, port in enumerate(ports):
        ...
        s.setnamed(p, "x", port.ddx * 1e-6)
        s.setnamed(p, "y", port.ddy * 1e-6)
